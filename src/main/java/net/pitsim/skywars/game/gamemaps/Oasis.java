...
//North
		spawnLocations.put(0, new Location(MapManager.getWorld(), 0.5, cageHeight, -94.5, 0, 0));
		spawnLocations.put(1, new Location(MapManager.getWorld(), 26.5, cageHeight, -61.5, 90, 0));
		spawnLocations.put(2, new Location(MapManager.getWorld(), 62.5, cageHeight, -25.5, 0, 0));
//East
		spawnLocations.put(3, new Location(MapManager.getWorld(), 95.5, cageHeight, 0.5, 90, 0));
		spawnLocations.put(4, new Location(MapManager.getWorld(), 62.5, cageHeight, 26.5, 180, 0));
		spawnLocations.put(5, new Location(MapManager.getWorld(), 26.5, cageHeight, 62.5, 90, 0));
//South
		spawnLocations.put(6, new Location(MapManager.getWorld(), 0.5, cageHeight, 95.5, 180, 0));
		spawnLocations.put(7, new Location(MapManager.getWorld(), -25.5, cageHeight, 62.5, -90, 0));
		spawnLocations.put(8, new Location(MapManager.getWorld(), -61.5, cageHeight, 26.5, -180, 0));
//West
		spawnLocations.put(9, new Location(MapManager.getWorld(), -94.5, cageHeight, 0.5, -90, 0));
		spawnLocations.put(10, new Location(MapManager.getWorld(), -61.5, cageHeight, -25.5, 0, 0));
		spawnLocations.put(11, new Location(MapManager.getWorld(), -25.5, cageHeight, -61.5, -90, 0));
