...
//West
	...
	public List<SkywarsChest> getChests() {
		...
		new SkywarsChest(new Location(MapManager.getWorld(), -1, 68, -84), 1, 1);
		new SkywarsChest(new Location(MapManager.getWorld(), -2, 72, -82), 1, 1);
		new SkywarsChest(new Location(MapManager.getWorld(), -2, 63, -83), 1, 1);

		new SkywarsChest(new Location(MapManager.getWorld(), 29, 68, -52), 1, 2);
		new SkywarsChest(new Location(MapManager.getWorld(), 27, 72, -53), 1, 2);
		new SkywarsChest(new Location(MapManager.getWorld(), 28, 63, -53), 1, 2);

		new SkywarsChest(new Location(MapManager.getWorld(), 50, 68, -29), 1, 3);
		new SkywarsChest(new Location(MapManager.getWorld(), 49, 72, -27), 1, 3);
		new SkywarsChest(new Location(MapManager.getWorld(), 49, 63, -28), 1, 3);

		new SkywarsChest(new Location(MapManager.getWorld(), 84, 68, -1), 1, 4);
		new SkywarsChest(new Location(MapManager.getWorld(), 82, 72, -2), 1, 4);
		new SkywarsChest(new Location(MapManager.getWorld(), 83, 63, -2), 1, 4);

		new SkywarsChest(new Location(MapManager.getWorld(), 52, 68, 29), 1, 5);
		new SkywarsChest(new Location(MapManager.getWorld(), 53, 72, 27), 1, 5);
		new SkywarsChest(new Location(MapManager.getWorld(), 53, 63, 28), 1, 5);

		new SkywarsChest(new Location(MapManager.getWorld(), 29, 68, 50), 1, 6);
		new SkywarsChest(new Location(MapManager.getWorld(), 27, 72, 49), 1, 6);
		new SkywarsChest(new Location(MapManager.getWorld(), 28, 63, 49), 1, 6);

		new SkywarsChest(new Location(MapManager.getWorld(), 1, 68, 84), 1, 7);
		new SkywarsChest(new Location(MapManager.getWorld(), 2, 72, 82), 1, 7);
		new SkywarsChest(new Location(MapManager.getWorld(), 2, 63, 83), 1, 7);

		new SkywarsChest(new Location(MapManager.getWorld(), -29, 68, 52), 1, 8);
		new SkywarsChest(new Location(MapManager.getWorld(), -27, 72, 53), 1, 8);
		new SkywarsChest(new Location(MapManager.getWorld(), -28, 63, 53), 1, 8);

		new SkywarsChest(new Location(MapManager.getWorld(), -50, 68, 29), 1, 9);
		new SkywarsChest(new Location(MapManager.getWorld(), -49, 72, 27), 1, 9);
		new SkywarsChest(new Location(MapManager.getWorld(), -49, 63, 28), 1, 9);

		new SkywarsChest(new Location(MapManager.getWorld(), -84, 68, 1), 1, 10);
		new SkywarsChest(new Location(MapManager.getWorld(), -82, 72, 2), 1, 10);
		new SkywarsChest(new Location(MapManager.getWorld(), -83, 63, 2), 1, 10);

		new SkywarsChest(new Location(MapManager.getWorld(), -52, 68, -29), 1, 11);
		new SkywarsChest(new Location(MapManager.getWorld(), -53, 72, -27), 1, 11);
		new SkywarsChest(new Location(MapManager.getWorld(), -53, 63, -28), 1, 11);
