...
public class Sounds {
	...
	public static final SoundEffect FUNKY_FEATHER_TELEPORT = new SoundEffect(Sound.ENDERMAN_TELEPORT, 1, 1F);
	...
	public static final SoundEffect CHICKEN = new SoundEffect(Sound.CHICKEN_HURT, 1, 1.2);
